...
using static Online_Examination_System.Views.Student.MyExamination;
    ...
    public partial class Marking : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    string query = "select * from submittedpaper where teachersId=" + userid + ";";
                    using (var reader = mySQL.ExecuteReader(query))
                    {
                        while (reader.Read())
                        {
                            ...
                            if(subPaper_Info.grades == "-1"|| subPaper_Info.grades == "-2")
                            {
